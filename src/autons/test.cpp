...
void testing(){
    ...
    chassis.moveToPoint(65, 47.88, 3000, {.forwards=true, .maxSpeed=90,.minSpeed=10}, true);
    pros::delay(3000);
    ...
    chassis.moveToPose(68, 14, 175, 1500, {.forwards=true, .maxSpeed=127, .minSpeed=127},true);
    pros::delay(500);
    gate.set_value(false);
    pto.set_value(false);
    pros::delay(500);
    ...
    chassis.moveToPoint(67, -48.5, 2300, {.forwards=true, .maxSpeed=127,.minSpeed=55}, true);
    pros::delay(2300);
    ...
    chassis.moveToPose(-45, -57.5, 270, 3000, {.forwards=true,.maxSpeed=110,.minSpeed=30},true);
    chassis.turnToHeading(271, 2000, {.maxSpeed=75,.minSpeed=2},false);
    ...
    chassis.moveToPoint(-29, -49.55, 800, {.forwards=false, .maxSpeed=75}, false);
    gate.set_value(true);
    pros::delay(100);
    intake.move(90);
    pros::delay(110);
    ...
    chassis.moveToPoint(-64.5, -47.85, 1800, {.forwards=true, .maxSpeed=65}, false);
    pros::delay(1800);

    
    //scoring #4

    chassis.moveToPoint(-28.5, -49.55, 300, {.forwards=false, .maxSpeed=100},true);
    chassis.moveToPoint(-28.5, -49.55, 1600, {.forwards=false,.maxSpeed=80},false);
    pto.set_value(true);
    matchload.set_value(false);
    gate.set_value(true);
    intake.move(0);
