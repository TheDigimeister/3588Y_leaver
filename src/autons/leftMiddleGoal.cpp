...
void leftMiddleGoal(){
    ...
    chassis.turnToPoint(-7, 18, 2000, {.forwards=true, .maxSpeed=100}, true);
    chassis.moveToPoint(-7, 18, 2000, {.forwards=true, .maxSpeed=90}, true);
    level.set_value(false);
    gate.set_value(false);
    chassis.turnToHeading(322,2000, {.maxSpeed=80}, false);
    right_mg.move(-80);
    left_mg.move(-80);
    pros::delay(330);
    intake.move(0);
    ...
    // right_mg.move(80);
    // pros::delay(1000);
    chassis.moveToPoint(-20, 38, 2000, {.forwards=false,.maxSpeed=127,.minSpeed=80});
    chassis.turnToHeading(300, 2000, {}, true);
